...
function enterRoom(){
    ...
    if(roomCode !== "" && roomList.has(roomCode)){
        ...
        document.getElementById("systemMessages").textContent = "Invalid room code";
        roomIDInput.value = null;
    }
}

function joinRoom(code){
    document.getElementById("systemMessages").textContent = "Joined room";
...
function newRoom() {
    ...
    document.getElementById("systemMessages").textContent = "New room created"
}
...
function leaveRoom(){
    ...
    roomIDInput.value = null;
    if(ws != null) {
        console.log("Leaving room"); // TODO need to add notif for leaving room on client side
        document.getElementById("systemMessages").textContent = "Left room";
        ws.close();
        currRoom = null;
        ws = null;
    }
...
document.getElementById('download').addEventListener('click', function(e){
    ...
    document.getElementById("systemMessages").textContent = "File saved";
